    ...
    <footer className="bg-background border-t py-12 md:py-16">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div>
            <h4 className="font-heading font-medium text-foreground mb-3">Explore</h4>
          ...
          <div>
            <h4 className="font-heading font-medium text-foreground mb-3">Company</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-heading font-medium text-foreground mb-3">Legal</h4>
            <ul className="space-y-2">
        ...
        <div className="pt-6 border-t flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <a 
              href="https://www.linkedin.com/in/rudrovalabs-agency-429863423/" 
              target="_blank" 
            ...
            <a 
              href="https://www.instagram.com/rudrovalabs/" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-full hover:bg-muted"
